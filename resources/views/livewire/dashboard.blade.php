<div x-data="{ inserirFornecedor: false, inserirPagamento: false, editarPagamento: false, user: false, open: false }">
    ...
    <section
        class="bg-slate-800 flex flex-row items-center justify-between p-2 overflow-x-auto fixed top-0 left-0 w-full z-50 text-nowrap">
    ...
    <section class="flex items-center justify-center w-full mt-16">

        <div class="w-full text-nowrap p-4">
            <table
                class="min-w-full table-auto border-collapse text-sm w-full h-full font-light text-left text-gray-600 shadow-lg ">
                <thead
                    class="text-xs tracking-wider text-gray-700 uppercase bg-gradient-to-b from-gray-50 to-gray-200 text-center h-14 sticky top-0">
                    <tr>
