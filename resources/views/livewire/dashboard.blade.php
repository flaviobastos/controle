    ...
    <section class="bg-slate-800 flex flex-row items-center justify-between p-2 overflow-x-auto">
        ...
        <div class="flex flex-row items-center justify-center">
            ...
            <button x-on:click="inserirFornecedor = true"
                ...
                <span class="hidden lg:inline-block">Cadastrar Fornecedor</span>
            </button>
            ...
            <button x-on:click="inserirPagamento = true"
                ...
                <span class="hidden lg:inline-block">Inserir Pagamento</span>
            </button>
            ...
            <div class="bg-gray-50 border border-gray-400 rounded-3xl shadow-md">
                <div class="flex flex-row items-center justify-center py-1">
                    ...
                    <input wire:model.live.debounce.800ms="buscar" name="buscar"
                        class="appearance-none bg-transparent border-none flex-grow text-gray-700 pl-3 tracking-wider focus:outline-none w-32 md:w-48 lg:w-auto"
                                    ...
                                    <div x-show="open" @click.outside="open = false"
                                        ...
                                        <form class="flex flex-col items-start justify-start">
                                            ...
                                            <div
                                                ...
                                                <select wire:model="id_fornecedor" id="id_fornecedor"
                                                    name="id_fornecedor"
                                            ...
                                            <div
                                                ...
                                                <select wire:model="mes"
                                                    class="focus:outline-none px-2 w-40 text-center uppercase">
