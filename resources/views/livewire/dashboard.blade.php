<div x-data="{ inserirContrato: false }">
    ...
    @if ($this->listaContratos->isNotEmpty())
        @foreach ($this->listaContratos as $contrato)
            <div class="flex flex-col items-center justify-center m-5 my-10">
                <div class="block font-normal text-sm tracking-wider">
                    <div class="border-1 border-neutral-400 py-3">
                        <p class="w-fit rounded-xl bg-slate-200 px-4 my-2 uppercase">
                            <strong>Contrato:</strong> <u>{{ $contrato->contrato }}</u>
                            <strong>Fornecedor:</strong> <u>{{ $contrato->fornecedor }}</u> <strong> CNPJ:</strong>
                            <u>{{ $contrato->cnpj }}</u>
                        </p>
                        <p class="w-fit rounded-xl bg-slate-200 px-4 my-2 uppercase"><strong>Objeto do
                                Contrato: </strong><u>{{ $contrato->objeto }} </p></u>
                    </div>
                </div>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-200">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <div class="flex items-center">
                                        <button wire:click=""
                                            class="inline-flex items-center px-5 py-1 rounded-3xl bg-slate-200 hover:bg-gray-300 duration-500 uppercase">
                                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" fill="#000000" viewBox="0 0 256 256" class="mr-2">
                                                <path
                        ...
                        <tbody>
                            @foreach ($this->listaPagamentos as $pagamento)
                                @if ($pagamento->contrato_id == $contrato->id)
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <button wire:click=""
                                                class="inline-flex items-center px-5 py-1 rounded-3xl hover:bg-gray-300 duration-500 uppercase">
