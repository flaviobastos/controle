                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <select id="selecionar_fornecedor" wire:model.live="id_fornecedor" wire:change="changeSupplier"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm uppercase rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 text-center">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="fornecedor" id="fornecedor" wire:model.defer="fornecedor"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 text-center uppercase"
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="objeto" rows="4" style="resize:none" wire:model.defer="objeto"
                            ...
                            placeholder="Escreva informações relacionadas as atividades/serviços do fornecedor" required="" maxlength="255"></textarea>
                    </div>
